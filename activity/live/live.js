...
Page({
    ...
    onLoad: async function (options) {
        var res = await ActivityModel.getRooms()
        this.setData({
            rooms: res.rooms
        })
    ...
    onShareAppMessage: function() {
        return {
            title: '虎彩30周年庆典-精彩照片直播',
            path: '/activity/live/live',
            imageUrl: 'http://hucai-simoo.oss-cn-hangzhou.aliyuncs.com/p1.hucai.com/20190326/C0002928120190326/origin/2ddb24aa13eb4fa99749215eeeb8cf6d.png'
        }
    },
})