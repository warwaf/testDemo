...
Page({
  ...
  data: {
    ...
    isRule: false,
    swiperList1: [{
        url: 'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/rushSample1.jpg'
      },
      {
        url: 'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/rushSample2.jpg'
      },
      {
        url: 'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/rushSample3.jpg'
      },
      {
        url: 'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/rushSample4.jpg'
      },
      {
        url: 'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/rushSample5.jpg'
      },
      {
        url: 'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/rushSample6.jpg'
      },
      // {
      //   url: 'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/rushSample7.jpg'
      // },
      // {
      //   url: 'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/rushSample8.jpg'
      // },
      // {
      //   url: 'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/rushSample9.jpg'
      // }
    ],
    showSignup: false,
    identityList: [{
  ...
  toPraise() {
    wx.navigateTo({
      url: '/pages/activityTA/clickPraise/clickPraise'
    });
  },
  // 去完善资料
  toUserDetail() {
    ...
    wx.navigateTo({
      url: '/pages/activityTA/seckilling/dataPerfect/index?way=00'
    });
  },
  // 去秒杀页
  toSeckill() {
    ...
    // }
    wx.navigateTo({
      url: '/pages/activityTA/seckilling/index'
    });
  },
  // 调用子组件关闭地址选择器
  closeRegionSelect() {
