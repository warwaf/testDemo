...
Page({
  ...
  data: {
    ...
    interval: 30, // 时间间隔
    isButton: true,
    setMeal: ['https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/setMeal1.jpg', 'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/setMeal2.jpg', 'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/setMeal3.jpg'],
    animatic1: [
      'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/rushSample1.jpg',
      'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/rushSample2.jpg',
      'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/rushSample3.jpg',
      'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/rushSample4.jpg',
      'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/rushSample5.jpg',
      'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/rushSample6.jpg',
      // 'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/rushSample7.jpg',
      // 'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/rushSample8.jpg',
      // 'https://hcmtq.oss-cn-hangzhou.aliyuncs.com/resource2020/activity/seckill_ta/rushSample9.jpg',
    ],
    mtaInfo: {
      name: "c_mtq_taian_seckill"
    }
  },
  ...
  getAnnouncement() {
    if (Date.parse(new Date()) > Date.parse('2020/10/24 14:00:30')) {
      this.setData({
        isAnnouncement: true
      })
    }
  ...
  getInitData() {
    ...
    wx.request({
      ...
      data: {
        ...
        activityId: app.globalData.actId ? app.globalData.actId : '1',
      },
      header: {
