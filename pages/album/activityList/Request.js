...
class Request extends Base {
     ...
     * 瀑布流加载
     */
    getRoomPhotos(scenes, activityId, pageNo, pageSize = 10) {
        let Host = this.apiSettings.Host
        // if (__wxConfig.accountInfo.appId == 'wx5030c4b2c3c30e86') {
        //     Host = 'https://mtqcshi.hucai.com'
        // }else{
        //     Host = 'https://mtquat.hucai.com:9233'
        // }
        return new Promise((resolve, reject) => {
            wx.request({
                url: `${Host}/iot/image/list`,
                data: {
                ...
                dataType: "json",
                header: {accessToken: app.globalData.mtq_token},
                method: 'POST',
